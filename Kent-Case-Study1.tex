...
We configure the switches and grant access to all the ports for future computers. In this page, we can set the switch for different cases in the lab. We used the default mode which consists of 8 ports (Figure \ref{fig:SWconf}).

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.48\textwidth]{Switchconf.jpg}
	\end{center}
	\caption{\small Ethernet Switch Switchport Configuration \newline}
	\label{fig:SWconf}
\end{figure}
...
We configure each Router Interface.(explain the code)\\
